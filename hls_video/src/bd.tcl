...
################################################################
# This is a generated script based on design: z7_hls_video
#
...
# source z7_hls_video_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net petten_gen_axis_0_out_r [get_bd_intf_pins petten_gen_axis_0/out_r] [get_bd_intf_pins v_axi4s_vid_out/video_in]
  ...
  connect_bd_intf_net -intf_net v_tc_0_vtiming_out [get_bd_intf_pins v_axi4s_vid_out/vtiming_in] [get_bd_intf_pins v_tc_0/vtiming_out]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins petten_gen_axis_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2dvi/PixelClk] [get_bd_pins v_axi4s_vid_out/aclk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net v_axi4s_vid_out_vtg_ce [get_bd_pins v_axi4s_vid_out/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins petten_gen_axis_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rgb2dvi/aRst_n] [get_bd_pins v_axi4s_vid_out/aresetn] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net xlconstant_0_dout1 [get_bd_ports hdmi_tx_hpd] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_dout [get_bd_pins petten_gen_axis_0/ap_start] [get_bd_pins xlconstant/dout]
