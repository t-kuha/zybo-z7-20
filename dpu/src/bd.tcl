...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_dpu [get_bd_pins clk_wiz_0/clk_dpu] [get_bd_pins dpu_eu_0/m_axi_dpu_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps_rst_dpu/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_dsp [get_bd_pins clk_wiz_0/clk_dsp] [get_bd_pins dpu_eu_0/dpu_2x_clk] [get_bd_pins ps_rst_dsp/slowest_sync_clk]
  connect_bd_net -net dpu_eu_0_dpu_interrupt [get_bd_pins dpu_eu_0/dpu_interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins dpu_eu_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins ps_rst_dpu/ext_reset_in] [get_bd_pins ps_rst_dsp/ext_reset_in] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net ps_rst_dpu_peripheral_aresetn [get_bd_pins dpu_eu_0/m_axi_dpu_aresetn] [get_bd_pins ps_rst_dpu/peripheral_aresetn]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins dpu_eu_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dpu_eu_0/S_AXI/reg0] SEG_dpu_eu_0_reg0
